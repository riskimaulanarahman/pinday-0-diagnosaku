                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <form action="/doctor/profil" method="POST">
                                @csrf
                                <div class="col-12 mb-3">
                                    <label class="form-label">Nama</label>
                                    <input type="text" name="name" value="{{$doctor->name}}" class="form-control" id="name" required>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" name="contact_person" value="{{$doctor->contact_person}}" class="form-control" id="contact_person" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" name="specialist" value="{{$doctor->specialist}}" class="form-control" id="specialist" required>
                                    </div>
                                </div>
